...
description: 构建带权重的决策标准体系，明确must-have与nice-to-have，并识别deal-breaker用于淘汰不合格选项。Use when the user says "决策标准", "decision criteria", "权重", "weighting", "must-have", "nice-to-have", or "一票否决".
