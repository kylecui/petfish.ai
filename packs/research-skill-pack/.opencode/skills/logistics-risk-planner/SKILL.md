...
description: 规划活动物流与风险应对，覆盖交通、住宿、物资、许可与应急预案，形成可执行保障方案。Use when the user says "后勤规划", "logistics planning", "风险预案", "risk contingency", "应急方案", "event logistics", "活动保障", or "backup plan".
