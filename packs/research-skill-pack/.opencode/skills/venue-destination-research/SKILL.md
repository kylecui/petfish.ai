...
description: 研究并评估活动场地或目的地的可达性、容量、成本、设施、安全与法规，形成可比较的候选清单。Use when the user says "场地调研", "venue research", "目的地选择", "destination research", "活动地点", "event location", "选酒店", or "where should we go".
