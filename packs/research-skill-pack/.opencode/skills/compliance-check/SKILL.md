...
description: 对候选方案开展合规风险研究，覆盖隐私、数据驻留、跨境传输与许可条款边界。Use when the user says "合规评估", "compliance check", "隐私风险", "data residency", "cross-border transfer", or "license compliance".
