...
研究灵感日志：记录“我突然想到”“记一下这个想法”的hypothesis/analogy/research-question/method-idea/experiment-idea等，绑定触发来源(source_ids/note_ids/context)、potential value与验证问题。Use when users ask to capture hunches/ideas not yet proven, for later validation instead of direct claims.
