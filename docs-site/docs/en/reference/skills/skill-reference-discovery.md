...
Search GitHub/public sources for high-quality agent skills, run skill reference scans, compare candidate repositories, evaluate credibility/maintenance/relevance/portability, extract reusable patterns, identify cautions or mismatches, and recommend adaptations for the current OpenCode skill pack.
