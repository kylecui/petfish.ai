...
基于decision brief、criteria与comparison matrix生成最终推荐，明确生效条件、备选/回退路径、风险、试点验证与决策日志。Use when the user says "最终建议", "recommendation", "final decision", "decision recommendation", "推荐方案", "go/no-go", "决策结论", "回退策略", "pilot", "PoC", "执行计划", or "decision log".
